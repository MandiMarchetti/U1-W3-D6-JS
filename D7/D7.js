...
//concatenar 
// due stringhe come parametri
// due caratteri della prima + ultimi 3 caratteri della seconda.
...
// funzione creando una array di 10 elementi
// valore random di 0 a 100

function randomNumber (){
const elementi = [];

for (let i = 0; i < 10; i++){
const randNumb = Math.floor(Math.random() * 101);
elementi.push(randNumb);
}
  return elementi;
}

const elementi = randomNumber();
...
// funzione per criamare solamente i numeri pari;


function trovarePari(array) {
  const nsoloPari = array.filter(function(numero) {
      return numero % 2 === 0;
  });
...
const myArray = [1,2,3,5,8,9,12,13,16,17,18,22];
var nsoloPari = trovarePari(myArray);
console.log(nsoloPari);
